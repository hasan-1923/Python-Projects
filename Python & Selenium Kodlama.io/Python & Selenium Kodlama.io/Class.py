...
class Student():
    ...
    def addStudent():
        name = input("isim giriniz: ")   #students listesine kullanıcıdan bilgi alıp kaydetmek
        age = input("yaş giriniz: ")
        gender = input("cinsiyet giriniz: ")
    ...
    def Update():
        ...
        if secim==1:
            NewStudent1.name=input("öğrenci ismi giriniz:").capitalize()
        ...
        if secim==2:
            NewStudent2.name=input("öğrenci ismi giriniz:").capitalize()
            ...
            print("Öğrenci bilgileri değiştirildi")
        if secim==3:
            NewStudent3.name=input("öğrenci ismi giriniz:").capitalize()
            ...
            print("Öğrenci bilgileri değiştirildi")  
        if secim==4:
            NewStudent4.name=input("öğrenci ismi giriniz:").capitalize()
...
for i in range(0,len(students)):
    print(students[i].name,students[i].age,students[i].gender)  
